...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Menu.findByIdPerfil", query = "SELECT m FROM Menu m WHERE m.idPerfil.idPerfil = :perfil")
...
public class Menu implements Serializable {
    ...
    public String toString() {
        return "cl.fgutierrez.legal.entidades.Menu[ idMenu=" + idMenu + " ]";
    }
